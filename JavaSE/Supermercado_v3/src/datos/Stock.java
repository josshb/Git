...
//    	return AddProducto(Simuladores.DarClaveNoRepe(), p);
    ...
    public void CasosDePrueba() {
        stock.put(1, new Producto("Leche", "Lacteos", 18));
        stock.put(2, new Producto("Manzanas", "Frutas", 38));
        stock.put(3, new Producto("Jamon York", "Embutidos", 3));
        stock.put(4, new Producto("Guisantes", "Congelados", 40));
        stock.put(5, new Producto("Galletas", "Desayuno", 4));
        stock.put(6, new Producto("Queso", "Lacteos", 5));
        stock.put(7, new Producto("Zumos", "Bebidas", 15));
    }
