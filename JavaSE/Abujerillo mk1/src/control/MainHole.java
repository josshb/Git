...
public class MainHole {
	...
	public static void main(String[] args) {
		...
		if (vejete==true) {
			System.out.println("Usted pagaría "+cuotainicial*descuentovejete);
			
		}else if (menorpapi==true) {
			System.out.println("Usted pagaría "+cuotainicial*descuentomenorpapi);

		}else if (menor==true) {
			System.out.println("Usted pagaría "+cuotainicial*descuentomenor);
			
			
		}else if (mujer==true) {
			
			System.out.println("Usted pagaría "+cuotainicial*descuentomujer);
